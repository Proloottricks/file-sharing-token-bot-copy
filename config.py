...
AUTO_DELETE_MSG = os.environ.get("AUTO_DELETE_MSG", "This file will be automatically deleted in 20 minutes(Due to Copyright Issues).")
...
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://bigosi6382:O27va822XtnY2LD0@cluster0.dfrtas8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002314480478"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1809208278,6376864232").split()):
        ADMINS.append(int(x))
except ValueError:
...
ADMINS.append(1809208278,6376864232)
